...
if(!function_exists('businesshub_get_current_url')){
	/* Get current page URL */
	function businesshub_get_current_url() {
		$pageURL = 'http';
...
if(!function_exists('businesshub_hex2rgb')){
	/* Convert Hexa to RGB */
	function businesshub_hex2rgb($hex) {
	   $hex = str_replace("#", "", $hex);
...
if(!function_exists('businesshub_get_gradientized_color')){
	/* 
	 ...
	 */
	function businesshub_get_gradientized_color($basic_hexa,$step_rgb){
		$basic_rbg = businesshub_hex2rgb($basic_hexa);
...
if(!function_exists('businesshub_hex2rgba')){
	function businesshub_hex2rgba($hex,$opacity) {
	   $hex = str_replace("#", "", $hex);
 ...
 *
 */
if(!function_exists('businesshub_get_formatted_string_number')) {
	function businesshub_get_formatted_string_number($n, $decimals = 2, $suffix = '') {
		if(!$suffix)
			$suffix = 'K,M,B';
...
if(!function_exists('businesshub_startsWith')){
	function businesshub_startsWith($haystack, $needle)
	{
 ...
 */
if(!function_exists('businesshub_get_google_font_name')){
	function businesshub_get_google_font_name($family_name){
		$name = $family_name;
		if(businesshub_startsWith($family_name, 'http')){
