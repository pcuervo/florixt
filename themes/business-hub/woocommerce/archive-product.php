...
$archives_sidebar = get_post_meta(get_option('woocommerce_shop_page_id'),'page_meta_sidebar',true);
if(!$archives_sidebar){
	$archives_sidebar = ot_get_option('woolist_sidebar','right');
}

get_header( 'shop' ); ?>
<div id="cactus-body-container" class="business-woolist">
